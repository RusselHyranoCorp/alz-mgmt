...
*/
starter_locations = ["germanywestcentral"]
...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "support@basecloud.de"
...
*/
    ...
    management_resource_group_name                 = "rg-prd-evhi-management-001"
    connectivity_hub_primary_resource_group_name   = "rg-network-prd-evhi-101"
   # connectivity_hub_secondary_resource_group_name = "rg-prd-evhi-hub-$${starter_location_02}"
    dns_resource_group_name                        = "rg-private-dns-prd-evhi-101"
    ddos_resource_group_name                       = "rg-prd-evhi-hub-ddos-001"
    asc_export_resource_group_name                 = "rg-prd-evhi-asc-export-001"
    service_health_alerts_resource_group_name      = "rg-service-health-prd-001"

    # Resource names management
    log_analytics_workspace_name            = "law-alz-prd-001"
    ddos_protection_plan_name               = "ddos-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "id-amba-prd-001"
    dcr_change_tracking_name                = "dcr-changetracking-prd"
    dcr_defender_sql_name                   = "dcr-defender-sql"
    dcr_vm_insights_name                    = "dcr-vminsights-prd"

    # Resource names primary connectivity
    primary_virtual_network_name                                 = "vnet-hub-prd-gwc-101"
    ...
    primary_route_table_user_subnets_name                        = "rt-snet-int-prd-gwc-101"
    ...
    primary_virtual_network_gateway_vpn_public_ip_name_1         = "pip-vgw-hub-vpn-001"
    primary_virtual_network_gateway_vpn_public_ip_name_2         = "pip-vgw-hub-vpn-002"
    primary_private_dns_resolver_name                            = "pdr-hub-dns-$${starter_location_01}"
    primary_bastion_host_name                                    = "bas-hub-001"
    primary_bastion_host_public_ip_name                          = "pip-bastion-hub-pip-001"
...
*/
   ...
   # secondary_auto_registration_zone_name = "$${starter_location_02}.azure.local"
    ...
    primary_hub_address_space                          = "10.19.0.0/16"
    primary_hub_virtual_network_address_space          = "10.19.21.0/24"
    primary_firewall_subnet_address_prefix             = "10.19.0.0/26"
    primary_firewall_management_subnet_address_prefix  = "10.19.0.192/26"
    primary_bastion_subnet_address_prefix              = "10.19.0.64/26"
    primary_gateway_subnet_address_prefix              = "10.19.0.128/27"
    primary_private_dns_resolver_subnet_address_prefix = "10.19.0.160/28"
